...
namespace QtSharpHelper.CHelper {
    ...
    public class CStruct<TCustomtype> {
        ...
        public void Dispose() {
            ...
            if (Pointer_Allocated != AllocatedMode.viaDll) return;
            Pointer_Allocated = AllocatedMode.None;
            Pointer = IntPtr.Zero;
            Struct = default(TCustomtype);
        }
        ...
        public bool MemoryAllocate() {
            if (Pointer_Allocated != AllocatedMode.None) return false;
        ...
        public bool MemoryFree() {
            if (Pointer_Allocated != AllocatedMode.viaNet) return false;
        ...
        public void CopyPtrToStruct() {
            if (Pointer_Allocated == AllocatedMode.None || Pointer.ToInt64() == 0)
                throw new System.Exception("Error Pointer undefined, no data to copy from");
