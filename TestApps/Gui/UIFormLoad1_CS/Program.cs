...
namespace UIFormLoad1_CS
{
    static class Program
    {
        ...
        public unsafe static QObject findChild<T>(QObject parent, string name, QtCore.Qt.FindChildOption options = QtCore.Qt.FindChildOption.FindChildrenRecursively) where T : QObject
        {
